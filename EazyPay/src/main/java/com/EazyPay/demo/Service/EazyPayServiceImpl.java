...
import com.EazyPay.demo.dao.EazyPayDao;
import com.EazyPay.demo.entity.Transaction_Details;
import com.EazyPay.demo.entity.Wallet;
@Service
public class EazyPayServiceImpl implements EazyPayService {

private Logger logger=GlobalLogger.getLogger(EazyPayServiceImpl.class);
